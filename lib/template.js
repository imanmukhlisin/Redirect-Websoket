...
<body>
  ...
  <div class="container">
    ...
    <!-- Monetization Card (Shopee Affiliate as Companion) -->
    <div class="card">
      <h2 class="card-title">Setup Companion for Best Result</h2>
      <p class="card-desc">To unlock the full potential of this Claude resource, we recommend pairing it with the following configuration/tool.</p>
