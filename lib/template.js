...
<body>
  ...
  <div class="container">
    ...
    <div class="card">
      <h2 class="card-title">Optimized Local Infrastructure</h2>
      ...
      <div class="hardware-layout">
        ...
        <div class="hardware-specs">
          Dedicated local server hemat daya untuk eksekusi automasi, scripting, dan Docker selama 24/7.
        </div>
        
        <div class="pro-tip">
          <strong>💡 Node:</strong>
          <span style="color:#C9D1D9;">"Setup ini sanggup angkat full stack automation (Postgres + Redis + API Server) tanpa throttling atau overheat. Modalnya sekali, akses root selamanya."</span>
        </div>
      </div>
